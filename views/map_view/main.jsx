/*
Before using this section of code, need to make sure that Google Maps API is
present:
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCHYlpfQhn1ns_pkwlpUx5BMkuHc40Xisc&v=3.19"></script>
<script src="map.jsx" type="text/jsx"></script>

These script tags should be preferably loaded through the head section of the HTML
*/
